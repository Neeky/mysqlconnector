...
%endif
%if 0%{?suse_version} && 0%{?suse_version} >= 1200
/usr/%_lib/python%py_ver/site-packages/_mysql_connector.so
/usr/%_lib/python%py_ver/site-packages/mysql_connector_python*.egg-info
%endif
%if 0%{?suse_version} && 0%{?suse_version} >= 1100 && 0%{?suse_version} < 1200
...
* Tue Jun 30 2015  Peeyush Gupta <peeyush.x.gupta@oracle.com> - 2.1.3-1
